...
begin
  ...
  loop
    ...
    values (
      ...
      v_birth_date,
      case
        when v_current_profile_id is not null and v_current_profile_id = v_local_profile_id then true
        when v_current_profile_id is null and v_synced_count = 0 then true
        else false
      end,
      null
    );
